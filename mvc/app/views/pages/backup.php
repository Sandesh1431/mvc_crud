...
//}
    ...
    <div class="container">
        <div style="display: flex;">
            ...
            if ($data['msg'] != '') {
            ?>
                <div class="edit_msg" id="ghdiv"><?php echo $data['msg']; ?></div>
            ...
            if ($data['del'] != '') {
            ?>
                <div class="del_msg" id="ghdiv"><?php echo $data['del']; ?></div>
            ...
            if ($data['added'] != '') {
            ?>
                <div class="add_msg" id="ghdiv"><?php echo $data['added']; ?></div>
                ...
                <tbody>
                    ...
                    ?>
                            <tr class="tr">
                                ...
                                <td class="img_pro">
                                    <h1 style="display: none;"><?php echo $photo[$i] ?></h1><img class="img" src='http://localhost/mvc/img/<?php echo $photo[$i] ?>'></td>
...
?>
<script>
  if(window.location.href == 'http://localhost/mvc/pages/editfrm/')
        {
            window.location = 'http://localhost/mvc/pages/table';
